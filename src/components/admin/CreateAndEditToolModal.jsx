...
// import { X, ChevronDown, Search, ImageIcon, Upload, Sparkles } from "lucide-react";
...
//       // Reset interaction dropdown query parameters
//       setCatSearch("");
//       setIsCatOpen(false);
...
//   // Click outside listener to automatically dismiss the custom dropdown drawer
//   useEffect(() => {
...
//   // Autofocus the search box input element immediately when toggled open
//   useEffect(() => {
...
//   // Client-side category filtering compute track
...
//             className="border-2 border-dashed border-gray-200 dark:border-slate-800/80 rounded-2xl p-5 bg-slate-50/50 dark:bg-[#141722]/30 hover:border-[#3981FA] dark:hover:border-[#3981FA] transition-colors relative group min-h-[120px] flex flex-col items-center justify-center cursor-pointer"
//           >
//             {preview ? (
...
//           {/* ─── UPGRADED PREMIUM CATEGORY SEARCHABLE DROPDOWN (NO ALL-CATEGORIES ROW) ─── */}
//           <div className="space-y-1.5 relative z-[99]" ref={catDropdownRef}>
//             <label className="block text-[10px] font-bold tracking-widest text-[#6A7281] dark:text-gray-500 uppercase pl-0.5">
...
//             {isCatOpen && (
//               <div className="absolute left-0 right-0 z-[100] mt-2 bg-[#CDDAF6] dark:bg-[#0c0e14] border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-2xl backdrop-blur-2xl animate-in">
                
//                 {/* Search query input field deck */}
...
//                       ref={catInputRef}
//                       type="text"
//                       placeholder="Search structural categories..."
//                       value={catSearch}
//                       onChange={(e) => setFolderSearch ? setCatSearch(e.target.value) : setCatSearch(e.target.value)}
...
//                 {/* Option loop track viewport list */}
...
//       {/* Physics Entrance Animations Keyframes Sheets Injection */}
//       <style>{`
...
//   // 🎛️ SEARCHABLE DROPDOWN STATES & REFS
//   const [isCatOpen, setIsCatOpen] = useState(false);
//   const [catSearch, setCatSearch] = useState("");
//   const catDropdownRef = useRef(null);
//   const catInputRef = useRef(null);
...
//           {/* ─── REFACTORED SEARCHABLE DROPDOWN (NO "ALL CATEGORIES" OPTION) ─── */}
//           <div className="space-y-1.5 relative z-[99]" ref={catDropdownRef}>
//             <label className="block text-[10px] font-bold tracking-widest text-[#6A7281] dark:text-gray-500 uppercase pl-0.5">
//               Category Group
//             </label>
...
//             {isCatOpen && (
//               <div className="absolute left-0 right-0 z-[100] bottom-full md:bottom-auto md:top-full mb-2 md:mb-0 md:mt-2 bg-[#CDDAF6] dark:bg-[#0c0e14] border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-2xl backdrop-blur-2xl animate-in shadow-black/10">
                
//                 {/* Search Header Input Field inside Dropdown Layer */}
//                 <div className="p-2 border-b border-slate-300/40 dark:border-slate-800/60 bg-white/20 dark:bg-slate-900/40">
//                   <div className="relative flex items-center">
//                     <Search size={12} className="absolute left-3 text-slate-500 dark:text-slate-400" />
//                     <input
...
//       {/* Physics Entrance Animations Keyframes Injection Rules */}
//       <style>{`
//         .scrollbar-premium::-webkit-scrollbar { width: 4px; height: 4px; }
//         .scrollbar-premium::-webkit-scrollbar-thumb { background: rgba(57, 129, 250, 0.15); border-radius: 10px; }
//         @keyframes modalInSpring {
