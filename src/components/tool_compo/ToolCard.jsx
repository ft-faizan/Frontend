...
// import { saveTool, deleteSavedTool } from "../../features/savedTools/savedToolSlice.js";
...
// showToast("Tool removed from saved");
//     } else {
...
//      showToast("Tool moved to trash", "error");
//   };
...
//   // Primary Action (Go/Open) - Solid #3380FF
//   const btnPrimary = `
//     ${btnBase}
...
//   // Secondary Action (Save/Edit/Move) - Subtle blue
//   const btnSecondary = `
//     ${btnBase}
...
//   // Danger Action (Delete/Remove) - Soft red
//   const btnDanger = `
//     ${btnBase}
...
//   // Success Action (Saved state) - Soft green
//   const btnSuccess = `
//     ${btnBase}
...
//   // Small square buttons for 2-col grid layout
//   const btnSqBase = `
...
//           style={{
//             background: "linear-gradient(105deg, transparent 40%, rgba(51,128,255,0.05) 50%, transparent 60%)",
//             transform: hovered ? "translateX(200%) skewX(-20deg)" : "translateX(-100%) skewX(-20deg)",
...
//           style={{
//             opacity: hovered ? 0 : 1,
//             transform: hovered ? "scale(0.8) translateY(-8px)" : "scale(1) translateY(0)",
...
//                 <span className="text-white font-black text-xl uppercase">{name?.charAt(0) || "?"}</span>
//               </div>
//             )}
//             {/* Saved dot */}
//             {isSaved && mode !== "saved" && (
...
//           <p className="mt-2.5 text-center text-[11px] font-bold text-gray-800 dark:text-gray-300 truncate w-full px-2 tracking-wide" title={name}>
//             {name}
//           </p>
//         </div>
...
//                 onClick={() => addRecentTool({ _id: tool._id || tool.toolId?._id, name, link, image })}
...
//           {/* ── SAVED — PLATFORM (3 btns: Open, Move, Remove) ── */}
//           {mode === "saved" && !isCustom && (
//             <div className="flex flex-col gap-1.5 flex-1 justify-center">
//               <a
//                 href={link} target="_blank" rel="noreferrer"
...
//                 <IconExternal /> Open
//               </a>
//               <button onClick={() => setModalOpen(true)} className={btnSecondary}>
//                 <IconFolder /> Move
//               </button>
//               <button onClick={handleTrashAndDelete} className={btnDanger}>
//                 <IconTrash /> Remove
//               </button>
//             </div>
//           )}

//           {/* ── SAVED — CUSTOM (4 btns: Open + Edit row, Move + Delete row) ── */}
//           {mode === "saved" && isCustom && (
//             <div className="flex flex-col gap-1.5 flex-1 justify-center">
//               {/* Row 1: Open + Edit (side by side) */}
...
//                   <IconExternal /> Open
//                 </a>
//                 <button onClick={() => onEdit(tool)} className={btnSqSecondary}>
//                   <IconEdit /> Edit
//                 </button>
//               </div>
//               {/* Row 2: Move + Delete (side by side) */}
//               <div className="flex gap-1.5">
//                 <button onClick={() => setModalOpen(true)} className={btnSqSecondary}>
//                   <IconFolder /> Move
//                 </button>
//                 <button onClick={handleTrashAndDelete} className={btnSqDanger}>
//                   <IconTrash /> Del
//                 </button>
//               </div>
//             </div>
...
//           {mode === "admin" && (
//             <div className="flex flex-col gap-1.5 flex-1 justify-center">
//               <button onClick={() => onEdit(tool)} className={btnPrimary}>
//                 <IconEdit /> Edit
//               </button>
//               <button onClick={() => onDelete(tool._id)} className={btnDanger}>
//                 <IconTrash /> Delete
//               </button>
//             </div>
//           )}
          ...
          {mode === "public" && (
            <div className="flex flex-col gap-1.5 flex-1 justify-center">
              <a
                ...
                rel="noreferrer"
                onClick={() => {
                  addRecentTool({ _id: tool._id || tool.toolId?._id, name, link, image });
          ...
          {mode === "saved" && !isCustom && (
            <div className="flex flex-col gap-1.5 flex-1 justify-center">
              ...
              {/* <button onClick={handleTrashAndDelete} */}
               <button
          onClick={() => setRemoveOpen(true)}className={btnDanger}>
                <IconTrash /> Remove
              </button>
            </div>
          )}
