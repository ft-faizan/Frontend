// pages/user_save/components/SavedToolsPagination.jsx
function SavedToolsPagination({ currentPage, totalPages, onPageChange }) {
...
export default SavedToolsPagination;