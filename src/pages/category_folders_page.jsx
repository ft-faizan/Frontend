...
//           Discover the best {name} tools curated
//           for your workflow.
...
//                 ${
//                   page === pageNum
//                     ? "bg-[#286FF0] text-white shadow-lg scale-105"
//                     : "bg-[#1c1f26] text-gray-500 hover:text-gray-300 hover:bg-[#252935]"
//                 }
//               `}
//             >
  ...
  useEffect(() => {
    dispatch(
      getTools({
        ...
        search: filters.search,
        page,
        limit: 25, // Upgraded from 5 to 9 for better grid balancing
      }),
    );
  }, [dispatch, id, filters.search, page]);
